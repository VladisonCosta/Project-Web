    ...
    return (
        <div className="flex items-center gap-5 bg-zinc-900 rounded-md overflow-hidden">
            ...
            <div className="flex flex-col justify-center flex-1">
                <span className="text-xl font-bold text-white">{props.item.produto.nome}</span>
                <span className="text-sm text-white">{props.item.produto.descricao}</span>
                <div className="flex items-center gap-2 mt-2 text-white text-lg font-bold">
